...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"RrnzpoisDalgaard",     (DL_FUNC) &RrnzpoisDalgaard,      2},
    {"RrnzpoisHarding",      (DL_FUNC) &RrnzpoisHarding,       2},
    {"RrtruncpoisDalgaard",  (DL_FUNC) &RrtruncpoisDalgaard,   3},
    {"RrtruncpoisHarding",   (DL_FUNC) &RrtruncpoisHarding,    3},
